 ...
 */
class TempestResponseV1SubCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TempestResponseV1SubCategory';
