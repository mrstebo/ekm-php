...
/**
 * V1AddProduct Class Doc Comment
 *
 * @category Class
 * @package  EkmPHP
 * @author   OpenAPI Generator team
 ...
 */
class V1AddProduct implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1AddProduct';
    ...
    public function setPrice($price)
    {
        ...
        if (!is_null($price) && ($price < 0)) {
            throw new \InvalidArgumentException('invalid value for $price when calling V1AddProduct., must be bigger than or equal to 0.');
        }
    ...
    public function setRrp($rrp)
    {
        ...
        if (!is_null($rrp) && ($rrp < 0)) {
            throw new \InvalidArgumentException('invalid value for $rrp when calling V1AddProduct., must be bigger than or equal to 0.');
        }
    ...
    public function setProductWeight($productWeight)
    {
        ...
        if (!is_null($productWeight) && ($productWeight < 0)) {
            throw new \InvalidArgumentException('invalid value for $productWeight when calling V1AddProduct., must be bigger than or equal to 0.');
        }
