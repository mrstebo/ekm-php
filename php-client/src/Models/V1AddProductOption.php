...
/**
 * V1AddProductOption Class Doc Comment
 *
 * @category Class
 * @package  EkmPHP
 * @author   OpenAPI Generator team
 ...
 */
class V1AddProductOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1AddProductOption';
    ...
    public function setSize($size)
    {
        ...
        if (($size > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $size when calling V1AddProductOption., must be smaller than or equal to 2147483647.');
        }
        if (($size < 1)) {
            throw new \InvalidArgumentException('invalid value for $size when calling V1AddProductOption., must be bigger than or equal to 1.');
        }
